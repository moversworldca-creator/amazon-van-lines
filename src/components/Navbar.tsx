  ...
  return (
    <header className="fixed w-full h-30 z-50 transition-all duration-300">
      ...
      <div className="bg-blue-900  text-white py-2 text-xs md:text-sm">
        <div className="container w-[95vw] mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
      ...
      <div className={`bg-white h-20 shadow-md transition-all duration-300 ${isScrolled ? 'py-2' : 'py-4'}`}>
        <div className="container w-[95vw] mx-auto px-4 flex justify-between items-center">
          {/* Logo Area */}
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 absolute w-full shadow-xl">
          <div className="w-[95%] flex flex-col p-4 space-y-4">
